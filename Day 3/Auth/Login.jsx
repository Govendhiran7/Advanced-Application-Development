    ...
    <div>
      <div className="login-container">
        ...
        <div className="right-side">
          <form>
            <h1>ChargeMeNow! Welcomes you back</h1>
            <div>
            ...
            <div>
              <h4>New member to ChargeMeNow? <span onClick={() => navigate('/register')}>Create account <i className="material-icons">chevron_right</i></span></h4>
            </div>
          </form>
        </div>
