    ...
    <div>
      ...
      <section className='margin'>
        <div className="section-2">
          ...
          <h3>Here is what makes ChargeMeNow the smarter wireless choice</h3>
        </div>
        ...
        <div className="overall-open-sauce-container">
          ...
          <div className="open-secret-sauce-container">
            ...
            <div className="open-secret-heading">
              ...
              <p>Your unlocked device and current phone number are always welcome at ChargeMeNow.</p>
            </div>
          </div>
          <div className="open-secret-sauce-container">
            <div className="icon-container">
      ...
      <section className='margin'>
        <div className="section-3">
          <div className="section-3-left-side">
            ...
            <h4>Get the ChargeMeNow for the fastest, easiest way to top-up any phone.</h4>
          </div>
      ...
      <section className='margin' id='faq'>
        <div className="section-4">
          <h1>Have a question about sending mobile recharge with ChargeMeNow?</h1>

          <details>
            <summary>What is ChargeMeNow</summary>
            <p>ChargeMeNow is the world is leading international mobile top-up platform. <br /> With ChargeMeNow, you can buy mobile top-ups for your own phone or send a prepaid mobile recharge online to someone else. You can send a top-up online whether it IS in app or online, and you can do it at any time or on any device that suits you.</p>
          </details>
          <details>
